...
const Concerts = () => {
  return (
    <>
        <div className={`h-[60vh] font-antic text-4xl text-white flex justify-center items-center bg-[linear-gradient(rgba(0,0,0,0.3),rgba(0,0,0,0.4)),url("/images/concerts/01.jpg")] bg-cover bg-center`}>
         <h1>Concerts</h1>
      </div>
        <div className='px-4 lg:px-8 pt-16 pb-8 flex lg:flex-row flex-col-reverse gap-12'>
          ...
          <section className='lg:w-[70vw] w-full'>
            ...
            <div className='my-6'  data-aos="blur-in" data-aos-once>
              <img src="/images/concerts/01.jpg" loading='lazy' className='h-[80vh] w-[100%] object-cover' alt="" />
            </div>
            <div  data-aos="blur-in" data-aos-once>
